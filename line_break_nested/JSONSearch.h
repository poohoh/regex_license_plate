...
public:
    ...
    result_struct search_foreign_vehicle_type(const std::string &input_string) const;
    result_struct search_military_vehicle_type(const std::string &input_string) const;
