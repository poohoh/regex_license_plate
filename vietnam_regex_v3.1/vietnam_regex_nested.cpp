...
int main()
{
    ...
    std::string input_string = "50MK153482";  // 입력 문자열
    ...
    try
    {
        ...
        result_list.push_back(search.search_foreign_vehicle_type(input_string));  // 외국 차종 검색
        result_list.push_back(search.search_military_vehicle_type(input_string));  // 군용 차량 종류 검색
